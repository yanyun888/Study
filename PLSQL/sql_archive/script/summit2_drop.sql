...
drop table s_customer cascade constraint;
drop table s_dept cascade constraint;
drop table s_emp cascade constraint;
drop table s_image cascade constraint;
drop table s_inventory cascade constraint;
drop table s_item cascade constraint;
drop table s_longtext cascade constraint;
drop table s_ord cascade constraint;
drop table s_product cascade constraint;
drop table s_region cascade constraint;
drop table s_title cascade constraint;
drop table s_warehouse cascade constraint;
